...
function setRole(role) {
  ...
  const activeBox = document.getElementById("role-" + role);
  if (activeBox) {
    activeBox.style.borderColor = "#ffb907";
    activeBox.style.background = "rgba(255, 185, 7, 0.1)"; 
    activeBox.style.transform = "scale(1.05)";
    
    selectedRole = role;
    console.log("Makeit - Selected Role: " + selectedRole);
  }
}